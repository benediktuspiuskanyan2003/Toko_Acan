      ...
      <div className='login-box'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='form-group'>
            ...
            {/* 2. WRAPPER RELATIVE: Agar icon bisa diatur posisinya */}
            <div style={{ position: 'relative' }}> 
                <input
                // 3. LOGIC TIPE INPUT: Jika showPassword true jadi text, jika false jadi password
                ...
                className='form-input'
                disabled={loading}
                // Tambahkan padding kanan agar text tidak tertutup icon mata
                ...
                <span 
                    ...
                    style={{
                        ...
                        cursor: 'pointer',
                        fontSize: '18px',
                        userSelect: 'none' // Agar icon tidak bisa diblok/select text
                    }}
                >
